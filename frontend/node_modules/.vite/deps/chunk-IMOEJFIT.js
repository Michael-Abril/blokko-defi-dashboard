...
function pointG2FromBytes(bytes) {
  ...
  const slc = (b, from6, to) => bytesToNumberBE(b.slice(from6, to));
...
function toString2(value) {
  return toString(toBytes2(value));
}
...
function getClientDataJSON(options) {
  ...
  return JSON.stringify({
    type: "webauthn.get",
    challenge: fromHex3(challenge, { url: true, pad: false }),
    origin,
    crossOrigin,
    ...extraClientData
  });
...
*/
//# sourceMappingURL=chunk-IMOEJFIT.js.map
