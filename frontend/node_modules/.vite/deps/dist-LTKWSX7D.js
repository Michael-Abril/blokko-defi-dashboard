  ...
  return createConnector((config2) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK: createBaseAccountSDK2 } = await import("./dist-LTKWSX7D.js");
...
*/
//# sourceMappingURL=dist-LTKWSX7D.js.map
