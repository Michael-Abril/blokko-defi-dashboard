...
import {
  ...
  validate,
  validate2
} from "./chunk-TJCCHSYA.js";
import {
  useQuery
} from "./chunk-FM4ECDTE.js";
import {
  import_index
} from "./chunk-AVTAJN6B.js";
import "./chunk-M6JLZ5G3.js";
import "./chunk-ALUSTTMD.js";
import {
  mainnet
} from "./chunk-FXC7AFBX.js";
import "./chunk-HQFV67P5.js";
import {
...
import {
  ...
  useMergeRefs,
  zeroRightClassName
} from "./chunk-WYNCMYCW.js";
import {
  __assign,
  __rest,
  __spreadArray,
  init_tslib_es6
} from "./chunk-R3WU7POE.js";
import {
  require_jsx_runtime
...
function fromString3(value) {
  return from11(fromString(value));
}
...
function fromRpc4(block, _options = {}) {
  var _a;
  if (!block)
    return null;
  const transactions = block.transactions.map((transaction) => {
...
function from14(options) {
  if (options.salt)
    return fromCreate2(options);
  return fromCreate(options);
}
function fromCreate(options) {
  const from25 = fromHex(from4(options.from));
  let nonce = fromNumber(options.nonce);
  if (nonce[0] === 0)
    nonce = new Uint8Array([]);
  return from4(`0x${keccak256(fromBytes2([from25, nonce], { as: "Hex" })).slice(26)}`);
}
function fromCreate2(options) {
  ...
  return from4(slice2(keccak256(concat(fromHex("0xff"), from25, salt, bytecodeHash), { as: "Hex" }), 12));
}
...
function from15(response, options = {}) {
...
function from16(provider, options = {}) {
  var _a, _b;
...
function from19(value, decimals = 0) {
...
function fromEther(ether, unit = "wei") {
  return from19(ether, exponents.ether - exponents[unit]);
}
function fromGwei(gwei, unit = "wei") {
  return from19(gwei, exponents.gwei - exponents[unit]);
}
...
function encode6(ver, ecc, data, type6) {
  let encoded = "";
...
function encodeQR(text, output = "raw", opts = {}) {
  ...
  if (ver !== void 0) {
    validateVersion(ver);
    data = encode6(ver, ecc, text, encoding);
  } else {
    for (let i = 1; i <= 40; i++) {
      try {
        data = encode6(i, ecc, text, encoding);
        ver = i;
        break;
      } catch (e) {
        err = e;
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-DYJRFPJK.js");
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-JXCYSCDT.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-72AYHV4Q.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-4PK6JJ4I.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-DN2M4H6G.js");
  ...
  return import_react57.default.createElement(
    ...
    (compactModeEnabled ? walletStep === "NONE" : true) && import_react57.default.createElement(
      ...
      import_react57.default.createElement(Box, { className: ScrollClassName, paddingBottom: "18" }, Object.entries(groupedWallets).map(
        ([groupName, wallets2], index2) => wallets2.length > 0 && import_react57.default.createElement(import_react57.Fragment, { key: index2 }, groupName ? import_react57.default.createElement(Box, { marginBottom: "8", marginTop: "16", marginX: "6" }, import_react57.default.createElement(
          Text,
          {
      ...
      walletContent = import_react72.default.createElement(Box, null, import_react72.default.createElement(
        ...
        mobileWallets.map((wallet, index2) => {
          ...
          return import_react72.default.createElement(
            ...
            )), index2 < mobileWallets.length - 1 && import_react72.default.createElement(
              Box,
              {
                background: "generalBorderDim",
                height: "1",
